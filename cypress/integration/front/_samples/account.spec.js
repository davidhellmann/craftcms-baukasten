...
sizes.forEach((size) => {
  describe(`Account on ${size} screen`, () => {
    ...
    it(`should contain an Orders section`, function () {
      ...
      cy.get('#header .cart-toggle').click();

      cy.get('#header .cart-menu a').contains('Orders').click();
    ...
    it(`should contain an Membership section`, function () {
      ...
      cy.get('#header .cart-menu a').contains('Membership').click();
    ...
    it(`should contain an Settings section`, function () {
      ...
      cy.get('#header .cart-menu a').contains('Settings').click();
